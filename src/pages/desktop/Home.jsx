...
const articles = [
  ...
  },
  {
    ...
    description: 'Five portfolio adjustments we recommend for balancing growth and protection this year.',
  },
]
...
const DesktopHome = () => {
  return (
    <div className="flex flex-col gap-20 pb-16">
      <section className="grid grid-cols-[1.1fr,0.9fr] items-center gap-16">
        <div className="space-y-8">
          ...
          <p className="max-w-xl text-lg leading-relaxed text-slate-600">
            Grow Invest delivers agile portfolio management, actionable climate-focused research, and experienced advisors who
            translate market complexity into confident decisions.
          </p>
          <div className="flex items-center gap-6 pt-2 text-sm font-medium">
            ...
            <a href="/blog" className="inline-flex items-center gap-2 text-slate-600 transition hover:text-brand-600">
              Explore insights
      ...
      <section className="rounded-3xl bg-white/90 p-12 shadow-xl shadow-brand-500/10 backdrop-blur">
      ...
      <section className="grid grid-cols-[1.1fr,0.9fr] gap-16">
        <div className="space-y-8">
          <h2 className="text-4xl font-semibold text-midnight">Market intelligence, distilled.</h2>
          <p className="max-w-xl text-lg leading-relaxed text-slate-600">
            Our research team continuously monitors macro trends, policy shifts, and emerging technologies. Every briefing
            transforms complex data into clear actions for your portfolio.
          </p>
        ...
        <div className="relative isolate overflow-hidden rounded-3xl bg-midnight px-10 py-12 text-white shadow-2xl">
